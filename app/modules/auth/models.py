...
class RefreshToken(Base):
    ...
    __table_args__ = (UniqueConstraint("token_lookup", name="refresh_tokens_token_lookup_key"),)
    ...
    token_lookup: Mapped[str | None] = mapped_column(String(64), nullable=True, index=True)
